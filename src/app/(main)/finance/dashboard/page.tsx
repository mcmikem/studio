  ...
  return (
    <div className="space-y-6 px-4 sm:px-0">
      <div className="overflow-hidden">
        <h1 className="font-heading text-2xl sm:text-3xl font-bold tracking-tight">Finance Dashboard</h1>
        <p className="text-muted-foreground text-sm">Overview of organizational finances, funds held by staff, and pending actions.</p>
      </div>
