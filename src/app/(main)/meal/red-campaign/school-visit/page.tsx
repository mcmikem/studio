      ...
      return (
          <Card>
              <CardContent className="pt-6 text-center">
                  <p className="text-destructive">Program ID is missing. Please return to the MEAL hub and select the form again.</p>
                   <Button asChild variant="outline" className="mt-4"><Link href="/meal"><ArrowLeft className="mr-2 h-4 w-4" />Back to MEAL Hub</Link></Button>
              </CardContent>
          </Card>
      )
  }
