...
import { Loader2, Package, DollarSign, List, ArrowLeft, Lightbulb } from 'lucide-react';
      ...
      <Card className="border-primary/30 bg-primary/5">
        <CardHeader>
          <CardTitle className="flex items-center gap-2 text-base">
            ...
            How this system works (simple guide)
          </CardTitle>
          <CardDescription>
            Step 1: Add products/materials with real names. Step 2: Log production. Step 3: Record sales. Step 4: Do inventory checks. Data updates across dashboards automatically.
          </CardDescription>
        </CardHeader>
      </Card>
