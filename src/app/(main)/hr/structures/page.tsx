...
const departments = [
    { name: 'Executive Office', lead: 'Mark Mutumba', count: 2, icon: ShieldCheck, color: 'text-rose-600', bg: 'bg-rose-50' },
    { name: 'Programs & Operations', lead: 'Sarah Namulondo', count: 8, icon: Layers, color: 'text-blue-600', bg: 'bg-blue-50' },
    { name: 'Finance & Admin', lead: 'James Kasozi', count: 3, icon: Briefcase, color: 'text-emerald-600', bg: 'bg-emerald-50' },
    { name: 'Media & Tech', lead: 'Creative Lead', count: 4, icon: Sliders, color: 'text-primary', bg: 'bg-primary/5' },
];
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div className="space-y-6">
              <div className="flex items-center justify-between px-2">
                  ...
                  <Badge variant="outline" className="text-[10px] font-black uppercase tracking-widest text-muted-foreground/40 border-none">Total: 4</Badge>
              </div>
