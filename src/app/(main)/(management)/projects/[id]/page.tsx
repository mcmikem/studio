         ...
         <TabsContent value="resources">
             <Card>
                <CardHeader className="flex flex-row justify-between items-center">
                 ...
                 <CardContent className="space-y-4">
                    <div>
                        <h4 className="font-semibold text-base mb-2">Documents & Templates</h4>
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                            <div className="flex items-center gap-3 p-3 border rounded-lg">
                                <BookOpen className="h-6 w-6 text-primary flex-shrink-0" />
                                <div>
                                    <p className="font-medium text-sm">Financial Literacy Booklet</p>
                             ...
                             <div className="flex items-center gap-3 p-3 border rounded-lg">
                                ...
                                <div>
                                    <p className="font-medium text-sm">Personal Budget Worksheet</p>
                                    <p className="text-xs text-muted-foreground">XLSX - 45KB</p>
                                </div>
                                <Button size="icon" variant="ghost" className="ml-auto"><Download className="h-4 w-4" /></Button>
                            </div>
                        </div>
                     ...
                     <div>
                        <h4 className="font-semibold text-base mb-2">Media Files</h4>
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                             <div className="flex items-center gap-3 p-3 border rounded-lg">
                                <Video className="h-6 w-6 text-primary flex-shrink-0" />
                                <div>
                                    <p className="font-medium text-sm">Workshop Intro Video</p>
                                    <p className="text-xs text-muted-foreground">MP4 - 25.6MB</p>
                                </div>
                                <Button size="icon" variant="ghost" className="ml-auto"><Download className="h-4 w-4" /></Button>
                            </div>
                        </div>
