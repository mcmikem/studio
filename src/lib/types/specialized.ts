...
export const SchoolXperienceSchema = z.object({
  ...
  activeProgrammes: z.array(z.enum(['SLF', 'RED', 'GreenSchools', 'PureWater', 'YoSkills'])).default([]),
...
export const SchoolVisitXperienceSchema = z.object({
  ...
  date: z.string(),
  visitor: z.string(),
  programmesCovered: z.array(z.enum(['SLF', 'RED', 'GreenSchools', 'PureWater', 'YoSkills'])),
