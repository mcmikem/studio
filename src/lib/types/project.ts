...
export const ProjectSchema = z.object({
  ...
  attendanceRate: z.coerce.number().optional(),
  learningImprovement: z.coerce.number().optional(),
  adoptionRate: z.coerce.number().optional(),
...
export const ProjectParticipantSchema = z.object({
    ...
    businessScore: z.coerce.number().optional(),
