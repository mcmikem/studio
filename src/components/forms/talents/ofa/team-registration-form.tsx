      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            ...
            OFA Team Registration Form (2025)
          </CardTitle>
          <CardDescription>
          ...
          <CardContent className="space-y-8">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2"><Label>Motto / Values / Culture Statement</Label><Input {...register('motto')} /></div>
              </div>
            </div>
                 ...
                 <h3 className="text-lg font-semibold border-b pb-2">Section H: Agreement</h3>
                  <div className="flex items-start space-x-2">
                    <Controller name="agreedToRules" control={control} render={({ field }) => (
                        <Checkbox id="agreedToRules" checked={field.value} onCheckedChange={field.onChange} className="mt-1" />
                    )} />
                    <div className="grid gap-1.5 leading-none">
                        <Label htmlFor="agreedToRules" className="font-semibold">Team commits to promote discipline, support player education, track attendance, and participate in OFA mentorship programs.</Label>
                    </div>
                </div>
