        ...
        <div className="flex h-8 w-8 items-center justify-center rounded-full bg-primary text-primary-foreground">
             <svg
              ...
              >
                ...
                <path d="M65.5 51.5C65.5 60.8873 57.8873 68.5 48.5 68.5C39.1127 68.5 31.5 60.8873 31.5 51.5C31.5 42.1127 39.1127 34.5 48.5 34.5C57.8873 34.5 65.5 42.1127 65.5 51.5Z" fill="#FFFFFF"/>
              </svg>
        </div>
