    ...
    <Card>
      <CardHeader>
        ...
        <CardDescription>
            ...
            <Link href="/management/metrics" className="text-primary hover:underline">Manage Metrics</Link>
        </CardDescription>
      </CardHeader>
      <CardContent className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-8 gap-y-6">
        ...
        {displayMetrics && displayMetrics.length > 0 ? (
          displayMetrics.map((metric) => {
             ...
             const formatValue = (val: number) => metric.unit === 'UGX' 
          ...
          !isLoading && (
            <div className="md:col-span-4 text-center text-muted-foreground py-8 flex flex-col items-center justify-center">
              ...
              <p className="text-sm">
                Go to{' '}
                <Link href="/management/metrics" className="text-primary hover:underline">
                  Metrics Management
                </Link>{' '}
