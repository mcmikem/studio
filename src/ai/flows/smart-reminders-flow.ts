    ...
    const smartRemindersPrompt = ai.definePrompt(
      {
        ...
        prompt: `Analyze the user's upcoming events and pending tasks from the provided tool outputs. Provide a specific, helpful list of 3-4 smart, actionable reminders.
